...
def cmd_register(a):
    ...
    if len(a.criterion.strip()) < 30:
        die("resolution criterion under 30 chars — not falsifiable enough to grade")
    try:
...
def main():
    ...
    for arg in ("--fclass", "--subject", "--probability", "--criterion", "--deadline"):
